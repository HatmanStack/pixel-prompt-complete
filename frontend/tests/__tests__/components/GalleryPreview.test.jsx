...
import GalleryPreview from '../../../src/components/gallery/GalleryPreview';
...
describe('GalleryPreview', () => {
  ...
  it('shows placeholder when no preview image', () => {
    ...
    // Placeholder shows emoji - check via container role
    const button = screen.getByRole('button');
    expect(button).toBeInTheDocument();
    // Both placeholder and info show count, so just verify we have the elements
    expect(screen.getAllByText('9 images')).toHaveLength(2);
  });
  ...
  it('displays image count with singular "image" when count is 1', () => {
    ...
    // Component correctly shows singular "image" for count of 1
