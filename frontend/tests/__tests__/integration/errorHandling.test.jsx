...
describe('Error Handling Flow - Integration', () => {
  ...
  it.skip('handles network error during generation', async () => {
  ...
  it.skip('handles 429 rate limit error', async () => {
    const user = userEvent.setup();
  ...
  it.skip('handles 400 content filter error', async () => {
    const user = userEvent.setup();
  ...
  it.skip('handles 404 job not found error during polling', async () => {
    const user = userEvent.setup();
  ...
  it.skip('shows error when trying to generate with empty prompt', async () => {
    const user = userEvent.setup();
  ...
  it.skip('recovers from error and allows retry', async () => {
    const user = userEvent.setup();
  ...
  it.skip('handles multiple simultaneous errors gracefully', async () => {
    const user = userEvent.setup();
