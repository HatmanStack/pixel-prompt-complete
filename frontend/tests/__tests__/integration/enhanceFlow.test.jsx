...
describe('Enhance Prompt Flow - Integration', () => {
  ...
  it.skip('completes full enhance flow: enter prompt → enhance → use enhanced → generate', async () => {
  ...
  it.skip('allows discarding enhanced prompt and starting over', async () => {
    const user = userEvent.setup();
  ...
  it.skip('handles enhancement error gracefully', async () => {
    const user = userEvent.setup();
  ...
  it.skip('shows loading state during enhancement', async () => {
    const user = userEvent.setup();
  ...
  it.skip('allows switching between short and long versions before using', async () => {
    const user = userEvent.setup();
