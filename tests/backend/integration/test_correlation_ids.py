...
These tests require a deployed backend.
...
# Skip all tests in this module if API_ENDPOINT is not set
pytestmark = pytest.mark.skipif(
    not API_ENDPOINT,
    reason="API_ENDPOINT environment variable not set - integration tests require deployed backend"
)
